                ...
                children: [
                   Container(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        Get.toNamed(RouteHelper.getFocalPerson());
                      },
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                          BigText(text: "सम्पर्क व्यक्तिका कार्यहरु",color: Colors.white,),
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        Get.toNamed(RouteHelper.getSocialGroupWork());
                      },
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      onTap:(){
                        Get.toNamed(RouteHelper.getHelpDetails());
                      },
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceAround,
                        children: [
                          BigText(text: "समन्वय तथा साझेदारी",color: Colors.white,),
                          Icon(Icons.arrow_forward,color: Colors.white,),
                        ],
                      ),
                    ),
