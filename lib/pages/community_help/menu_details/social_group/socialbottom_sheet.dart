...
class SocialBottomSheet extends StatelessWidget {
   SocialBottomSheet({required this.pageId});
int pageId;
  @override
  Widget build(BuildContext context) {
    var group= Get.find<SocialWorkController>().socialWorkList[pageId];
    return Container(
           ...
           child: Container(
             ...
             child: SingleChildScrollView(
               ...
               child: Column(
                 ...
                 SizedBox(height: 3,),
                 NormalInfo(bigtext: "कामको विवरण :",smalltext: group.kamkoBibarand.toString(),),
                 SizedBox(height: 3,),
                 NormalInfo(bigtext: "सहभागी संख्या :",smalltext: group.sahabhagiSankha.toString(),),
                 SizedBox(height: 3,),
                 NormalInfo(bigtext: "लक्षित वर्ग :",smalltext: group.lichitBarga.toString(),),
                 SizedBox(height: 3,),
                 Align(
      ...
      SizedBox(height: 3,),
                 NormalInfo(bigtext: "लाभान्वित परिवार :",smalltext: group.labhandita.toString(),),
                 SizedBox(height: 3,),
