...
import 'package:thadri/pages/monthly_management/monthly_menu/fund_management/fundbottom_sheet.dart';
import 'package:thadri/pages/text/text.dart';

class FundManagement extends StatefulWidget {
  const FundManagement({Key? key}) : super(key: key);

  @override
  State<FundManagement> createState() => _FundManagementState();
}

class _FundManagementState extends State<FundManagement> {
  @override
  Widget build(BuildContext context) {
    var pageId=Get.parameters['pageId'];
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("कोष सम्बन्धी व्यवस्था")),
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: GetBuilder<FundManagementController>(builder: (group){
                return group.isLoaded?ListView.builder(
                  itemCount: group.fundManagementList.length,
            ...
            return GestureDetector(
              onTap: (){
               showModalBottomSheet(
                 ...
                 return FundBottomSheet(pageId: index);
               });
              },
              child: Card(
                color: Colors.grey.shade300,
                    child: Padding(
                      ...
                      child: ListTile(
                        title: Text(
                          group.fundManagementList[index].samuhaName!.samuhakoName.toString(),
                          style: TextStyle(
                            fontSize: 20,
                          ),
                        ),
                        leading: CircleAvatar(
                          child: Text(
                            group.fundManagementList[index].id.toString(),
                            style:
